...
describe('TaskItem Component', () => {
    ...
    beforeEach(() => {
        render(_jsx(TaskItem, { task: task, toggleTask: mockToggleTask, deleteTask: mockDeleteTask }));
    });
    ...
    test('displays completed task correctly', () => {
        ...
        render(_jsx(TaskItem, { task: completedTask, toggleTask: mockToggleTask, deleteTask: mockDeleteTask }));
